...
def generate_launch_description():
    ...
    bridge = Node(
        ...
        arguments=['/cmd_vel@geometry_msgs/msg/Twist@ignition.msgs.Twist',
                   ...
                   #'/world/leonardo_race_field/model/fra2mo/link/base_footprint/sensor/camera/image@sensor_msgs/msg/Image[ignition.msgs.Image',
                   #'/world/leonardo_race_field/model/fra2mo/link/base_footprint/sensor/camera/camera_info@sensor_msgs/msg/CameraInfo[ignition.msgs.CameraInfo',
                   ],
